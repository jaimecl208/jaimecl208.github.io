...
function loadModelAndAnimations() {
    ...
    // Cargar modelo base
    loader.load('models/furbo/Ch38_nonPBR.fbx', function (object) {
        ...
        const animations = ['models/furbo/Standing Idle.fbx', 'models/furbo/Fast Run.fbx', 'models/furbo/Soccer Pass.fbx'];
